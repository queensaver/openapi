...
type Stand struct {
	...
	// A stand can have many hives. However, when sending POST or PUT requests you can only update the stand metadata, any hives attached to it will be ignored. You will have to do the hive call instead to update hives. This data will only be populated with GET requests.
