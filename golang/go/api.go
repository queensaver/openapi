...
type DefaultApiRouter interface { 
	...
	ConfigsBhiveAssociatePost(http.ResponseWriter, *http.Request)
...
type DefaultApiServicer interface { 
	...
	ConfigsBhiveAssociatePost(context.Context, string, string, int64) (ImplResponse, error)
	...
	ScaleGetV2(context.Context, string, int64, int64, string, string) (ImplResponse, error)
