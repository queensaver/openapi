...
type DefaultServiceClient interface {
	...
	TelemetryPost(ctx context.Context, in *TelemetryPostRequest, opts ...grpc.CallOption) (*models.BboxConfigResponse, error)
...
func (c *defaultServiceClient) TelemetryPost(ctx context.Context, in *TelemetryPostRequest, opts ...grpc.CallOption) (*models.BboxConfigResponse, error) {
	out := new(models.BboxConfigResponse)
...
type DefaultServiceServer interface {
	...
	TelemetryPost(context.Context, *TelemetryPostRequest) (*models.BboxConfigResponse, error)
...
func _DefaultService_TelemetryGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TelemetryGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DefaultServiceServer).TelemetryGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/openapi.services.defaultservice.DefaultService/TelemetryGet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DefaultServiceServer).TelemetryGet(ctx, req.(*TelemetryGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DefaultService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TelemetryGet",
			Handler:    _DefaultService_TelemetryGet_Handler,
		},
		{
